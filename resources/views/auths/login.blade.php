...
<head>
    ...
    <title>SISFO SM UNAND</title>
    <style>
        body {
            margin: 0;
            padding: 0;
            font-family: sans-serif;
            background: linear-gradient(to right, #2DC653, #92E6A7);
        }
...
<body>
    <div class="kotak_login">
        ...
        @endif
        <img src="/unand.png" alt="unand" class="unand">
        <br>
        <h5 class="font-weight-bold text-center">SISFO Surat Menyurat</h5>
        <h4 class="font-weight-bold text-center">BEM HIMA SE-UNAND</h4>
